    ...
    <section className="hero" id="hero">
      <div className="hero__content">
        ...
        <div className="hero__head">
          ...
          {/* Purple half-circle — exact Figma SVG wedge */}
          <svg className="hero__purple-shape" viewBox="0 0 117 146" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="hero__images-container">
          ...
          {/* Left decorative SVG — red S-curve (Figma exact) */}
          ...
          {/* Left decorative SVG — dark S-curve (Figma exact) */}
